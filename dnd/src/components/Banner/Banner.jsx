      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            >
              Dance Revolution Academy — a pan-India platform for
              choreographers, participants, and franchise partners to showcase
              talent, compete, and grow together.
            </p>
